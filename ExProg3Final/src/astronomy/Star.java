...
/**
 * Esta clase representa una estrella con sus distintos datos característicos.
...
public class Star {
	...
	private float ra, dec; // coordenadas ecuatoriales de la estrella en el cielo (ascensión recta y
							// declinación)
	 ...
	 * @param ra            ascensión recta de la estrella (coordenadas
	 *                      ecuatoriales)
	 ...
	 * @param luminosity    luminosidad de la estrella como múltiplo de la
	 *                      luminosidad solar
	 * @param spectralType  tipo espectral de la estrella
	 */
	public Star(String name, float ra, float dec, Constellation constellation, float distance, float magnitude,
			float luminosity, SpectralType spectralType) {
		this.name = name;
	...
	/**
	 * Nombre propio de la estrella. La mayoría de la estrellas no tienen nombre
	 * propio
	 * 
	...
	/**
	 * Metodo que devuelve un STring con formato para exportar en txt
	 * 
	 * @return
	 */
	public String toStringExport() {
		return "(" + ra + "," + dec + ") -> Distancia:" + distance + ", Luminosidad:" + luminosity + ", " + name;
	}

	/**
	 * Devuelve un vector de 7 posiciones (0 al 6) con la informacion en String del
	 * nombre, ra, dec, distancia, magnitud, luminosida y tipo espectral en ese
	 * orden
	 * 
	 * @return
	 */
	public Vector<String> getDataTabla() {
		Vector<String> data = new Vector<>();
		data.add(0, name);
		data.add(1, ra + "");
		data.add(2, dec + "");
		data.add(3, distance + "");
		data.add(4, magnitude + "");
		data.add(5, luminosity + "");
		data.add(6, spectralType.toString());
		return data;
	}
}
