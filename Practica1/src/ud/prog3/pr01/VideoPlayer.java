...
/**
 * Ventana principal de reproductor de v�deo Utiliza la librer�a VLCj que debe
 * estar instalada y configurada
 * (http://www.capricasoftware.co.uk/projects/vlcj/index.html)
 * 
 * @author Andoni Egu�luz Mor�n Facultad de Ingenier�a - Universidad de Deusto
 */
public class VideoPlayer extends JFrame {
	...
	public VideoPlayer() {
		...
		mediaPlayerComponent.getMediaPlayer().addMediaPlayerEventListener(new MediaPlayerEventAdapter() {
			...
			public void timeChanged(MediaPlayer mediaPlayer, long newTime) {
				pbVideo.setValue((int) (10000.0 * mediaPlayerComponent.getMediaPlayer().getTime()
	...
	/**
	 * Ejecuta una ventana de VideoPlayer. El path de VLC debe estar en la variable
	 * de entorno "vlc". Comprobar que la versi�n de 32/64 bits de Java y de VLC es
	 * compatible.
	 * 
	 * @param args Un array de dos strings. El primero es el nombre (con comodines)
	 *             de los ficheros, el segundo el path donde encontrarlos. Si no se
	 *             suministran, se piden de forma interactiva.
	 */
	public static void main(String[] args) {
		...
		// System.out.println( LibVlc.INSTANCE.libvlc_get_version() ); // Visualiza
		// versi�n de VLC encontrada
